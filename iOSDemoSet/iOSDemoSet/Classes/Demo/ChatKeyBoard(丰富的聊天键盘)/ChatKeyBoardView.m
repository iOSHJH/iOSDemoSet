...
//  iOSDemoSet
//
//  Created by 黄俊煌 on 2017/11/16.
//  Copyright © 2017年 yunshi. All rights reserved.
//

#import "ChatKeyBoardView.h"

@interface ChatKeyBoardView ()<UITextViewDelegate,UICollectionViewDataSource,UICollectionViewDelegate>
...
- (void)prepareSetup {
    ...
    // 注册cell
    [self.collectionView registerClass:[EmoticonCell class] forCellWithReuseIdentifier:CellIdentifer];
...
- (void)KeyboardWillChangeFrameNotification:(NSNotification *)notification {
    ...
    if (ScreenHeight - endFrame.origin.y == 0) {
        ...
        [self.toolView mas_updateConstraints:^(MASConstraintMaker *make) {
            make.left.right.equalTo(self);
            make.bottom.equalTo(self).offset(-(ScreenHeight - endFrame.origin.y));
            make.height.equalTo(@50);
        }];
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    EmoticonCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CellIdentifer forIndexPath:indexPath];
